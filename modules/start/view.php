...
<section class="content">
    ...
    <div class="row">
        ...
        if ($_SESSION['permisos_acceso'] == '1') {
            ...
            include("templates/ref_pedidos_compras.php");

            include("templates/ref_movi_compras.php");

            include("templates/ref_movi_ventas.php");

            include("templates/ref_movi_stock.php");
            ...
            include("templates/ref_movi_stock.php");
        } elseif ($_SESSION['permisos_acceso'] == '3') {
