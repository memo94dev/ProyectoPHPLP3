<section class="content-header">
    ...
    <h1>
        ...
        <a href="?module=form_departamento&form=add" class="btn btn-primary btn-social pull-right" title="Agregar" data-toggle="tooltip">
                ...
                <div class="box-body">
                    <table id="dataTables1" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $query = mysqli_query($mysqli, "SELECT * FROM departamento ORDER BY id_departamento ASC")
                            ...
                            while ($data = mysqli_fetch_assoc($query)) {
                                ...
                                echo "<tr>
                                      ...
                                      <div><a data-toggle='tooltip' data-placement='top' title='Editar' class='btn btn-primary btn-sm' 
                                           ...
                                           <a href="modules/departamento/proses.php?act=delete&id_departamento=<?php echo $id_departamento; ?>" 
                                           data-toggle="tooltip" data-data-placement="top" title="Eliminar Datos" 
                                           class="btn btn-danger btn-sm" onclick="return confirm('¿Estas seguro/a de eliminar <?php echo $dep_descripcion; ?>?')">
