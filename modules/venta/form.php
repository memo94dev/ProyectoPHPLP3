...
<?php if ($_GET['form'] == 'add') { ?>
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-edit icon-title"></i> Cargar Nueva Venta
        </h1>
        <ol class="breadcrumb">
            <li><a href="?module=start"><i class="fa fa-home"></i> Inicio</a></li>
            <li><a href="?module=venta"> Ventas</a></li>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-9">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="cod_venta" value="<?php echo $codigo ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-9">
                                    ...
                                    <div class="col-sm-5">
                                        <select required class="chosen-select" data-placeholder="Seleccionar Cliente" autocomplete="off" name="id_cliente" id="">
                                            <option value=""></option>
                                            <?php
                                            $query_cli = mysqli_query($mysqli, "SELECT id_cliente, ci_ruc, cli_nombre, cli_apellido 
                                                                                FROM clientes ORDER BY id_cliente ASC")
                                                or die('Error: ' . mysqli_error($mysqli));
                                            while ($data_cli = mysqli_fetch_assoc($query_cli)) {
                                                echo "<option value=\"$data_cli[id_cliente]\"> $data_cli[cli_nombre] $data_cli[cli_apellido] - $data_cli[ci_ruc]</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
